<?php
namespace Aindong\LaravelPdfGen;

use Aindong\LaravelPdfGen\Exception as Exceptions;
...
abstract class AbstractGenerator implements GeneratorInterface
{
     ...
     * Useful when letting laravelpdfgen deal with file creation
     *
    ...
    protected function createTemporaryFile($content = null, $extension = null)
    {
        $filename = rtrim($this->getTemporaryFolder(), DIRECTORY_SEPARATOR)
            . DIRECTORY_SEPARATOR . uniqid('aindong_pdf', true);
        if (null !== $extension) {
            $filename .= '.'.$extension;
        }
        if (null !== $content) {
